      ...
      for (int j = 0;
        ...
        if (widget.totaldata != null) {
          for (int k = 0;
              ...
              k++) {
            for (int m = 0;
                m < widget.totaldata['observationEylf'].length;
                m++) {
    ...
    for (int i = 0; i < assesData['Montessori']['Subjects'].length; i++) {
      ...
      for (int j = 0;
        ...
        for (int k = 0;
          ...
          inx2.add(inx1);
          if (widget.totaldata != null &&
              widget.totaldata['obsMontessori'].length > k) {
            //edit purpose
            cur1.add(
                            ...
                            selectedChildrens.length > 0
                                ? Wrap(
                                    ...
                                    children: List<Widget>.generate(
                                      ...
                                      return selectedChildrens[index].id != null
                                          ? GestureDetector(
                                              onTap: () {
                                                Navigator.push(
                                                    context,
                            ...
                            files.length > 0
                                ? ReorderableWrap(
                                    ...
                                    onReorder: (int oldIndex, int newIndex) {
                                      ...
                                      String caption1 =
                                          captions[oldIndex].text.toString();
                                      String caption2 =
                                          captions[newIndex].text.toString();
                            ...
                            mediaFiles.length > 0
                                ? ReorderableWrap(
                                    ...
                                    onReorder: (int oldIndex, int newIndex) {
                                      ...
                                      _editMediaFileChildren[oldIndex] = child2;
                                      _editMediaFileChildren[newIndex] = child1;
                                      ...
                                      _editMediaFileEducators[oldIndex] = edu2;
                                      _editMediaFileEducators[newIndex] = edu1;
                                      setState(() {});
                                    },
                                    children: List<Widget>.generate(
                                                                    ...
                                                                    Container(
                                                                        ...
                                                                        decoration:
                                                                          ...
                                                                          image:
                                                                              new DecorationImage(
                                                                            image:
                                                                                new NetworkImage(Constants.ImageBaseUrl + mediaFiles[index]['filename']),
                                                                            fit:
                                                                                BoxFit.cover,
                                                                          ),
                                                                        )),
                                                                      ...
                                                                      children: [
                                                                        VideoItem(
                                                                            ...
                                                                            height: size.height /
                                                                                8,
                                                                            url:
                                                                                Constants.ImageBaseUrl + mediaFiles[index]['filename']),
                                                                        SizedBox(
                                                                          height:
                                                                              8,
                                                                        ),
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                    ...
                                    onTap: () async {
                                      if (selectedChildrens.length > 0) {
                                        ...
                                        for (int i = 0;
                                            ...
                                            i++) {
                                          child.add(selectedChildrens[i].id);
                                        }
                                        ...
                                        for (int i = 0;
                                            i < mediaFiles.length;
                                            i++) {
                                          String p = 'upl-media-tags-child' +
                                              mediaFiles[i]['id'];
                                          List ch = [];
                                          if (_editMediaFileChildren[i].length >
                                              0) {
                                            for (int j = 0;
                                                j <
                                                ...
                                                j++) {
                                              ch.add(int.parse(
                                                  _editMediaFileChildren[i][j]
                                                      .id));
                                            }
                                          }
                                          mp[p] = jsonEncode(ch);

                                          String u = 'upl-media-tags-educator' +
                                              mediaFiles[i]['id'];
                                          List ed = [];
                                          if (_editMediaFileEducators[i]
                                            ...
                                            for (int j = 0;
                                                ...
                                                j++) {
                                              ed.add(int.parse(
                                                  _editMediaFileEducators[i][j]
                                                      .id));
                                            }
                                          }
                                          mp[u] = jsonEncode(ed);

                                          String k = 'upl-media-tags-caption' +
                                              mediaFiles[i]['id'];
                                        ...
                                        for (int i = 0; i < files.length; i++) {
                                          ...
                                          List ed = [];
                                          if (_editEducators[i].length > 0) {
                                            for (int j = 0;
                                                j < _editEducators[i].length;
                                                j++) {
                                              ed.add(int.parse(
                                          ...
                                          mp[k] = captions[i].text.toString();

                                          String m = 'obsMedia' + i.toString();
                                          mp[m] = await MultipartFile.fromFile(
                                              file.path,
                                ...
                                GestureDetector(
                                    ...
                                    if (selectedChildrens.length > 0) {
                                      ...
                                      if (widget.type == 'edit') {
                                        ...
                                        if (mediaFiles.length > 0) {
                                          for (int k = 0;
                                              k < mediaFiles.length;
                                              k++) {
                                            priorities.add(mediaFiles[k]['id']);
                                            origin.add("UPLOADED");
                                            mediaApi.add(mediaFiles[k]['id']);
                                          }
                                        }
                                        ...
                                        if (files.length > 0 ||
                                          ...
                                          mp['priority'] =
                                              jsonEncode(priorities);
                                          mp['origin'] = jsonEncode(origin);
                                          mp['mediaid'] = jsonEncode(mediaApi);
                                        }
                                      } else {
                                        mp = {
                                          "childrens": jsonEncode(child),
                                      ...
                                      for (int i = 0;
                                        ...
                                        String u = 'upl-media-tags-educator' +
                                            mediaFiles[i]['id'];
                                        List ed = [];
                                        if (_editMediaFileEducators[i].length >
                                            0) {
                                          for (int j = 0;
                                              j <
                                                  _editMediaFileEducators[i]
                                      ...
                                      for (int i = 0; i < files.length; i++) {
                                        ...
                                        String k = 'obsCaption_' + i.toString();
                                        mp[k] = captions[i].text.toString();
                                  ...
                                  child: Container(
                                      width: MyApp.USER_TYPE_VALUE == 'Parent'
                                          ? 80
                                          : 112,
                                      height: 38,
                                      decoration: BoxDecoration(
