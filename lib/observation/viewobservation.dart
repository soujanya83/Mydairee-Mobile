...
class ViewObservationState extends State<ViewObservation> {
  ...
  Future<void> fetchRoomsOnly(String centerId, dynamic totaldata) async {
    try {
      RoomAPIHandler handler = RoomAPIHandler({
        "userid": MyApp.LOGIN_ID_VALUE,
        "centerid": centerId, // ✅ Use correct center id
      });
      ...
      if (data != null && !data.containsKey('error')) {
        ...
        if (res != null && res is List) {
          ...
          try {
            print('taped');
            selectedRooms.clear();
            print(totaldata['observation']['room'].toString());
            List<String> selectedRoomsList =
                totaldata['observation']['room'].toString().split(',');
  ...
  Future<void> _fetchData() async {
    ...
    if (!data1.containsKey('error')) {
      ...
      try {
        fetchRoomsOnly(data1['observation']['centerid'].toString(), data1);
      } catch (e) {}
      try {
                ...
                child: Padding(
                    ...
                    child: Container(
                        child: Column(
                                      ...
                                      children: List<Widget>.generate(
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: Chip(
                                            ...
                                            label: Text(_allChildrens[index]
                                                        .childName !=
                                                    null
                                  ...
                                  Wrap(
                                      ...
                                      children: List<Widget>.generate(
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: Chip(
                                            label: Text(selectedRooms[index]
                                                        .room
                                                        .name !=
                                                    "null"
                                                              ...
                                                              children: [
                                                                ListTile(
                                                                    leading:
                                                                      ...
                                                                      child:
                                                                          Icon(
                                                                        eylfData[index].activity[p].choosen
                                                                            ? Icons.keyboard_arrow_down
                                                                            : Icons.keyboard_arrow_right,
                                                                        color: Constants
                                                                            .kMain,
                          ...
                          Visibility(
                              visible:
                                  montessoriData != null && expandmontessori,
                              child: Container(
                                  width:
                                      MediaQuery.of(context).size.width * 0.9,
                                  child: ListView.builder(
                                                              ...
                                                              children: [
                                                                ListTile(
                                                                    leading:
                                                                      ...
                                                                      child:
                                                                          Icon(
                                                                        montessoriData[index].activity[p].choosen
                                                                            ? Icons.keyboard_arrow_down
                                                                            : Icons.keyboard_arrow_right,
                                                                        color: Constants
                                                                            .kMain,
                          ...
                          if (displaydata1 != null && obsFetched)
                            Container(
                              child: ListView.builder(
                                  ...
                                  physics: NeverScrollableScrollPhysics(),
                                  itemCount:
                                      displaydata1['Comments'].length != 0
