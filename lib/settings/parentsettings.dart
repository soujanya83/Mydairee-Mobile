...
@override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: settingsDataFetched? SingleChildScrollView(
            child: Padding(
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => AddParent('add',null))).then((value) {
                                      if (value != null) {
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(parentStats['totalParents'].toString(),
                                    style:
                                        Constants.containerNumberHeadingStyle)
                              ],
                            ),
                          ),
                          Expanded(
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('Active Parents',
                                    style: Constants.containerHeadingStyle),
                                Text(parentStats['activeParents'].toString(),
                                    style:
                                        Constants.containerNumberHeadingStyle)
                              ],
                            ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('InActive Parents',
                                    style: Constants.containerHeadingStyle),
                                Text(parentStats['inactiveParents'].toString(),
                                    style:
                                        Constants.containerNumberHeadingStyle)
                              ],
                            ),
                            ...
                            child: Column(
                              ...
                              children: [
                                Text('Pending Parents',
                                    style: Constants.containerHeadingStyle),
                                Text(parentStats['pendingParents'].toString(),
                                    style:
                                        Constants.containerNumberHeadingStyle)
                              ],
                            ),
  ...
  Widget parentCard(int index) {
    return _allParents[index].name.toLowerCase().contains(searchString.toLowerCase())? Card(
      child: Container(
              ...
              children: [
                Padding(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage:  _allParents[index].imageUrl!=null && _allParents[index].imageUrl!=''?NetworkImage(
                        Constants.ImageBaseUrl + _allParents[index].imageUrl):null
                  ),
                ),
                SizedBox(
                  width: 10,
                ...
                Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                        onTap: () {
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => AddParent('edit', _allParents[index].userid))).then((value) {
                                      if (value != null) {
                                      settingsDataFetched=false;
                                        setState(() {});
                                        _fetchData();
                    ...
                    Text(_allParents[index].status!=null?_allParents[index].status:''),
                    Text(_allParents[index].dob!=null?_allParents[index].dob:'')
                  ],
                )
              ],
            )
