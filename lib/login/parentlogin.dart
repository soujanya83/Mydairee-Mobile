    ...
    final name = Theme(
      ...
      labelText: "Username",
        hintStyle: new TextStyle(
          color: Constants.kGrey.withOpacity(0.8)
          ),
        contentPadding: EdgeInsets.fromLTRB(5.0, 10.0, 20.0, 10.0),
        labelStyle: new TextStyle(color: Constants.kGrey),
        suffixIcon: IconButton(icon: Icon(Icons.minimize,color: Colors.transparent,), onPressed: null)
      ),
      ...
      backgroundColor: Colors.white,
        body: Stack(
          children: <Widget>[
            ...
            loggingIn ? Center(child : new CircularProgressIndicator()) : new Container(),
          ],
        ) 
    );
  }
