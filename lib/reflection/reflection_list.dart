                                                                  ...
                                                                  return Container(
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          _reflection[index].childs[indexs]['imageUrl'] != '' && _reflection[index].childs[indexs]['imageUrl'] != null
                                                                              ? CircleAvatar(
                                                                                  radius: 10.0,
                                                                          ...
                                                                          Text(
                                                                            _reflection[index].childs[indexs]['name'],
                                                                            style:
                                                                                Constants.header3,
                                                                          ),
                                                                        ],
                                                        ...
                                                        ? Container(
                                                            ...
                                                            child: ListView
                                                              ...
                                                              itemBuilder:
                                                                  (context,
                                                                      indexs) {
                                                                return _reflection[index].media[indexs]['mediaUrl'] !=
                                                                            null &&
